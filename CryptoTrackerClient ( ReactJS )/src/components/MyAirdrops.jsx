...
//         if (!formData.airdropName || !formData.airdropLink || !formData.airdropType || !formData.connectedVia) {
...
//             fetchAirdrops();
//             setFormData({ airdropName: '', airdropLink: '', referCode: '', airdropType: '', connectedVia: '' });
//         } catch (error) {
...
//         <FormContainer>
//             <MainForm>
//                 {message && (message.includes('exists') ? <ErrorMessage>{message}</ErrorMessage> : <SuccessMessage>{message}</SuccessMessage>)}
...
//                 {airdropList.filter(a => a.currentUser === currentUser.email).map((airdrop, index) => (
//                     <Card key={index}>
